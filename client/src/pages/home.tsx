...
export default function Home() {
  ...
  const categories = useMemo(() => {
    ...
    const uniqueCategories = [
      ...new Set(dresses.map((dress) => dress.category)),
    ];
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <section
        id="home"
        className="hero-luxury text-white min-h-screen flex items-center"
      >
        <div
          style={{
            backgroundImage:
              "url('https://images.unsplash.com/photo-1441986300917-64674bd600d8?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1920&h=1080')",
            backgroundSize: "cover",
            backgroundPosition: "center",
            backgroundAttachment: "fixed",
          }}
      ...
      <section id="collections" className="py-20 section-luxury">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="section-title-luxury text-4xl sm:text-5xl mb-6">
              {t("collections.title")}
            </h2>
            <p className="text-boutique-700 text-lg max-w-3xl mx-auto leading-relaxed">
              {t("collections.subtitle")}
          ...
          <div className="mb-12">
            ...
            <div className="md:hidden">
              ...
              <div className="results-count-mobile">
                ...
                {filteredDresses.length === 1 ? "dress" : "dresses"} found
            ...
            <div className="hidden md:block space-y-6">
              ...
              <div className="flex flex-wrap justify-center gap-4 items-center">
                <div className="flex items-center space-x-2">
                  <Filter className="h-5 w-5 text-boutique-600" />
                  <span className="font-medium text-boutique-700">
                    Filters:
                  </span>
                </div>
          ...
          {error && (
            <div className="text-center py-12">
              <p className="text-gray-500">
                Failed to load dresses. Please try again later.
              </p>
            </div>
          )}
            ...
            filteredDresses.length === 0 && (
              <div className="text-center py-12">
                <div className="glass-effect p-8 rounded-2xl max-w-md mx-auto">
                  ...
                  <h3 className="text-xl font-semibold text-boutique-700 mb-2">
                    No dresses found
                  </h3>
      ...
      <section id="about" className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="section-title-luxury text-4xl sm:text-5xl mb-8">
            {t("about")}
          </h2>
          <div className="max-w-4xl mx-auto">
            <p className="text-boutique-700 text-xl leading-relaxed mb-8">
              At Yakshu Boutique, we believe that every woman deserves to feel
              beautiful and confident. Our carefully curated collection features
              the finest fabrics and latest designs, ensuring you always look
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mt-16">
              <div className="glass-effect p-8 rounded-2xl">
                ...
                <h3 className="text-xl font-semibold text-boutique-800 mb-3">
                  Premium Quality
                </h3>
                <p className="text-boutique-600">
      ...
      <section id="contact" className="py-20 section-luxury">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="section-title-luxury text-4xl sm:text-5xl mb-12">
            {t("contact")}
          </h2>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 max-w-4xl mx-auto">
            <div className="glass-effect p-8 rounded-2xl">
              ...
              <h3 className="text-2xl font-semibold text-boutique-800 mb-4">
                Contact Number
              </h3>
              <a
                href="tel:+919080007550"
                className="text-boutique-600 text-xl font-medium"
              >
                +91 90800 07550
              </a>
            </div>
